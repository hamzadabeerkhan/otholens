...
- a Python FastAPI service with health and placeholder analysis endpoints;
...
The returned OA probabilities are placeholders until a trained and evaluated model is promoted. The interface labels them accordingly.

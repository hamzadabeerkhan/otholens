...
def decide(probabilities: list[float], *, minimum_confidence: float = 0.55, out_of_distribution: bool = False) -> GuardrailDecision:
    ...
    if out_of_distribution:
        return GuardrailDecision("abstained", None, confidence, "input_outside_validated_distribution")
